...
Installnvim(){
	...
	nvim -c "CocInstall coc-clangd coc-cmake coc-emmet coc-git coc-highlight coc-jedi coc-json coc-pyright coc-jedi coc-sh coc-snippets coc-vimlsp coc-yaml coc-syntax coc-ccls" ./nviminstall.info
}
